...
public class ClothsDryerDialogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cloths_dryer_dialog);
    ...
    private void getDialogItemList() {
        ...
        String surl = "http://111.93.182.173/IFBiOSApi/api/ModelByCategory?CategoryID=IFBPC1000005&SecurityCode=" + prefManager.getSecurityCode();
