...
import com.genius.ifbretailer.adapter.ECatelogAdapter;
import com.genius.ifbretailer.adapter.ECatelougeAdapter;
...
public class ECatelogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_catelog);
        initialize();
        getItemlist();
        onClick();
    }
    ...
    private void getItemlist(){
        ...
        String surl = "http://111.93.182.173/IFBiOSApi/api/get_ProductCatalog?ECatalogID=0&CategoryId=0&Operation=1";
