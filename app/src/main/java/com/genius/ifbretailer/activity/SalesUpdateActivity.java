...
public class SalesUpdateActivity extends AppCompatActivity {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                int pos=modelID.indexOf(ModelID);
                                spModel.setSelection(pos);
    ...
    private void successAlert(String text) {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alerDialog1.dismiss();
                Intent intent = new Intent(SalesUpdateActivity.this, ConsolidateSalesReportActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void invalidemailalert(String text) {
        android.app.AlertDialog.Builder dialogBuilder = new android.app.AlertDialog.Builder(SalesUpdateActivity.this, R.style.CustomDialogNew);
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
