...
public class WMFLUDialogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wmfludialog);
    ...
    private void getDialogItemList(){
        ...
        String surl = "http://111.93.182.173/IFBiOSApi/api/ModelByCategory?CategoryID=IFBPC1000021&SecurityCode=" + prefManager.getSecurityCode();
