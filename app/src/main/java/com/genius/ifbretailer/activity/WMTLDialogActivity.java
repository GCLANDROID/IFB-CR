...
public class WMTLDialogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wmtldialog);
    ...
    private void getDialogItemList() {
        ...
        String surl = "http://111.93.182.173/IFBiOSApi/api/ModelByCategory?CategoryID=IFBPC1000025&SecurityCode=" + prefManager.getSecurityCode();
