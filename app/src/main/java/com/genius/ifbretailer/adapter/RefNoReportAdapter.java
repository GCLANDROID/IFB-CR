...
public class RefNoReportAdapter extends RecyclerView.Adapter<RefNoReportAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        if (reportList.get(i).getCancel().equals("")){
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tvDate,tvModelName,tvCustomerName,tvCustomerPhn,tvCustomerEmail,tvRefNo,tvDeliveryDate,tvRemarks,tvCancel,tvStatus,tvTokenNo,tvTiketNo;
        LinearLayout llCopy;
